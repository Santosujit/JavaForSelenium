...
//As we know, finally block is always executed therefore the finally block in the method b() is executed first 
//and prints a message. At last, the exception is handled by the catch block of the method a().
